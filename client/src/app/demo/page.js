    ...
    switch (page.type) {
      case 'welcome':
        return (
          <Box sx={{ display: 'flex', minHeight: '80vh', alignItems: 'center', gap: { xs: 4, md: 8 }, flexDirection: { xs: 'column', md: 'row' } }}>
            <Box sx={{ flex: 1 }}>
              <Typography variant="h1" sx={{ color: '#f5f5f5', fontWeight: 800, mb: 2, fontSize: { xs: '2.5rem', md: '4rem' }, lineHeight: 1.1 }}>
                {page.title}
              </Typography>
              <Typography variant="h4" sx={{ color: '#00ff88', mb: 4, fontWeight: 400, fontSize: { xs: '1.5rem', md: '2rem' } }}>
                {page.subtitle}
              </Typography>
              <Typography variant="h6" sx={{ color: '#d0d0d0', lineHeight: 1.7, mb: 6, fontSize: { xs: '1rem', md: '1.25rem' } }}>
                {page.content}
              </Typography>
              <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: 'repeat(2, 1fr)' }, gap: 3, mb: 6 }}>
                {page.stats.map((stat, index) => (
                  <Box key={index} sx={{ textAlign: 'center', p: 3, border: '1px solid #555', borderRadius: 2, background: 'rgba(45,45,45,0.8)' }}>
                    <Typography variant="h3" sx={{ color: '#00ff88', fontWeight: 700, mb: 1, fontSize: { xs: '1.5rem', md: '2rem' } }}>
                      {stat.number}
                    </Typography>
      ...
      case 'demo':
        return (
          <Box sx={{ display: 'flex', minHeight: '80vh', alignItems: 'center', gap: { xs: 4, md: 8 }, flexDirection: { xs: 'column', md: 'row' } }}>
            <Box sx={{ flex: 1 }}>
              <Typography variant="h2" sx={{ color: '#f5f5f5', fontWeight: 700, mb: 2, fontSize: { xs: '2rem', md: '3rem' } }}>
                {page.title}
              </Typography>
              <Typography variant="h4" sx={{ color: '#00ff88', mb: 4, fontWeight: 400, fontSize: { xs: '1.25rem', md: '1.5rem' } }}>
                {page.subtitle}
              </Typography>
              <Typography variant="h6" sx={{ color: '#d0d0d0', lineHeight: 1.7, mb: 6, fontSize: { xs: '1rem', md: '1.25rem' } }}>
                {page.content}
            ...
            <Box sx={{ flex: 1 }}>
              <video 
                ...
                width="100%" 
                height="400"
                style={{ borderRadius: '16px', border: '2px solid #555' }}
              >
          ...
          <Box sx={{ display: 'flex', minHeight: '80vh', alignItems: 'center', gap: { xs: 4, md: 8 }, flexDirection: { xs: 'column', md: 'row' } }}>
            <Box sx={{ flex: 1 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', mb: 3, flexDirection: { xs: 'column', sm: 'row' }, textAlign: { xs: 'center', sm: 'left' } }}>
                <page.icon sx={{ fontSize: 60, color: '#00ff88', mr: { xs: 0, sm: 3 }, mb: { xs: 2, sm: 0 } }} />
                <Box>
                  <Typography variant="h2" sx={{ color: '#f5f5f5', fontWeight: 700, mb: 1, fontSize: { xs: '1.75rem', md: '2.5rem' } }}>
                    {page.title}
                  </Typography>
                  <Typography variant="h4" sx={{ color: '#00ff88', fontWeight: 400, fontSize: { xs: '1.25rem', md: '1.5rem' } }}>
                    {page.subtitle}
                  </Typography>
                </Box>
              </Box>
              ...
              <Box sx={{ p: 4, border: '1px solid #00ff88', borderRadius: 3, background: 'rgba(0,255,136,0.05)' }}>
                <Typography variant="h6" sx={{ color: '#00ff88', mb: 3, fontWeight: 600 }}>
                  What Happens in This Step:
                </Typography>
                {page.details.map((detail, index) => (
                  <Box key={index} sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    <CheckCircle sx={{ color: '#00ff88', mr: 2, fontSize: 20 }} />
                    <Typography variant="body1" sx={{ color: '#e0e0e0' }}>
                      {detail}
                    </Typography>
                  </Box>
            ...
            <Box sx={{ flex: 1 }}>
              <Box sx={{ 
                ...
                <Box sx={{ textAlign: 'center', p: 4 }}>
                  <page.icon sx={{ fontSize: 120, color: '#00ff88', mb: 3, opacity: 0.3 }} />
        ...
        return (
          <Box sx={{ minHeight: '80vh', py: 6 }}>
            <Box sx={{ textAlign: 'center', mb: 8 }}>
              ...
              <Typography variant="h6" sx={{ color: '#d0d0d0', maxWidth: 800, mx: 'auto', fontSize: { xs: '1rem', md: '1.25rem' } }}>
                {page.content}
              </Typography>
            </Box>
            <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: 'repeat(2, 1fr)' }, gap: 6 }}>
              {page.stories.map((story, index) => (
                <Box key={index} sx={{ 
                  ...
                  <Typography variant="h4" sx={{ color: '#f5f5f5', mb: 2, fontWeight: 700 }}>
                    {story.name}
                  </Typography>
                  ...
                  <Typography variant="h6" sx={{ color: '#00ff88', mb: 4 }}>
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'space-around', mb: 4, flexDirection: { xs: 'column', sm: 'row' }, gap: { xs: 2, sm: 0 } }}>
                    <Box>
                      ...
                      <Typography variant="body2" sx={{ color: '#d0d0d0' }}>Timeline</Typography>
                    </Box>
                    <Box>
                      <Typography variant="h5" sx={{ color: '#00ff88', fontWeight: 700 }}>
                        {story.salary}
                      </Typography>
                      <Typography variant="body2" sx={{ color: '#d0d0d0' }}>Salary Increase</Typography>
                    </Box>
                  </Box>
      ...
      case 'cta':
        return (
          <Box sx={{ minHeight: '80vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', textAlign: 'center' }}>
            <Typography variant="h1" sx={{ color: '#f5f5f5', fontWeight: 800, mb: 3, fontSize: { xs: '2.5rem', md: '4rem' } }}>
              {page.title}
            </Typography>
            <Typography variant="h3" sx={{ color: '#00ff88', mb: 6, fontWeight: 400, fontSize: { xs: '1.5rem', md: '2rem' } }}>
              {page.subtitle}
            </Typography>
            <Typography variant="h5" sx={{ color: '#d0d0d0', lineHeight: 1.7, mb: 8, maxWidth: 800, mx: 'auto', fontSize: { xs: '1rem', md: '1.25rem' } }}>
              {page.content}
            </Typography>
            ...
            <Box sx={{ display: 'flex', gap: 4, justifyContent: 'center', flexDirection: { xs: 'column', sm: 'row' } }}>
              <Button variant="contained" sx={{ 
                ...
                fontSize: '1.3rem',
                fontWeight: 700,
                '&:hover': { background: '#00ff88', color: '#000' }
              }}>
              ...
              <Button variant="outlined" sx={{ 
                ...
                fontSize: '1.3rem',
                fontWeight: 700,
                '&:hover': { borderColor: '#e0e0e0', color: '#e0e0e0', background: 'transparent' }
              }}>
            ...
            {demoPages.map((_, index) => (
              <Box
                ...
                sx={{
                  ...
                  borderRadius: '50%',
                  background: index === currentPage ? '#00ff88' : '#666',
                  cursor: 'pointer'
                }}
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', maxWidth: '1400px', mx: 'auto' }}>
          <Button
            ...
            sx={{ 
              ...
              fontSize: '1rem',
              fontWeight: 600,
              '&:hover': { borderColor: '#666', color: '#e0e0e0', background: 'transparent' },
              '&:disabled': { opacity: 0.3, borderColor: '#404040', color: '#888' }
            }}
          >
            Previous
          </Button>
          ...
          <Button
            ...
            sx={{ 
              ...
              fontWeight: 700,
              '&:hover': { background: '#00ff88', color: '#000' },
              '&:disabled': { opacity: 0.3, background: '#555', color: '#888' }
            }}
          >
